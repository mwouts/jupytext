...
[Jupyter notebooks](http://jupyter.org/) are a convenient way to write documents that contain interactive code.

However, they have one major drawback: no editor other than Jupyter can edit its `.ipynb` files.

The `jupytext` package lets you to write your notebooks directly as Python, R, Markdown or R Markdown scripts.
...
- Have a look at the sample Python and Markdown notebooks in the [demo](https://github.com/mwouts/jupytext/tree/master/demo) folder. See how notebooks are represented as text.
- Run them and compare them to the original Jupyter notebook on [![Binder](https://mybinder.org/badge.svg)](https://mybinder.org/v2/gh/mwouts/jupytext/master?filepath=demo).
