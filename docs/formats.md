...
Another popular notebook-like format for Python scripts is the Sphinx-gallery [format]([https://sphinx-gallery.github.io/stable/syntax.html](https://sphinx-gallery.github.io/stable/syntax.html)). Scripts that contain at least two lines with more than twenty hash signs are classified as Sphinx-Gallery notebooks by Jupytext.
