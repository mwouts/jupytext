...
- Pairing groups allow you to define different pairing configurations for specific subsets of notebooks. Use `[pairing_groups.<name>]` sections in your configuration file to apply different pairing rules to notebooks in different locations, such as generating documentation markdown files only for tutorial notebooks ([#1383](https://github.com/mwouts/jupytext/issues/1383))
