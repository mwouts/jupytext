...
to your jupytext.toml file
    ...
    if "require_hash" in inspect.signature(base_contents_manager_class.get).parameters:
        JupytextAsyncContentsManager.get = (
            JupytextAsyncContentsManager._get_with_require_hash_argument
        )
    else:
        JupytextAsyncContentsManager.get = (
            JupytextAsyncContentsManager._get_with_no_require_hash_argument
        )

    return JupytextAsyncContentsManager
